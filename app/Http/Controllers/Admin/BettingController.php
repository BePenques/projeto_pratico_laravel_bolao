...
class BettingController extends Controller
{
    ...
    public function validateMsg(){
      ...
      return $messages = [
        'title.required' =>__('bolao.Required',['atributo'=>trans('bolao.name')]),
        'score_points.required' =>__('bolao.Required',['atributo'=>trans('bolao.description')]),
        'extra_points.required' =>__('bolao.Required',['atributo'=>trans('bolao.description')]),
        'rate_points.required' =>__('bolao.Required',['atributo'=>trans('bolao.description')]),
